            ...
            for (var c = e.widgetMap[Symbol.iterator](), u; !(t = (u = c.next()).done); t = !0) {
                ...
                if (!(f.isComplete || f.isFailed || f.isResetting)) {
                    var C = f.watchcat.seq - 1 - qr,
                        ...
                        M = f.isOverrunning && f.watchcat.overrunBeginSeq < k;
            ...
            if (n.source === U) {
                ...
                if (!(!n.widgetId || !m.widgetMap.has(n.widgetId))) {
                    ...
                    if (!(!i || !r)) switch (n.event) {
                        case "init":
                            {
                                var l;r.widgetInitStartTimeTsMs = j();
                                var s = r.shadow.getElementById(i);s || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                r.mode = n.mode,
                                r.nextRcV = n.nextRcV,
                                r.mode === H.Invisible && r.params["refresh-expired"] === K.Manual && b("refresh-expired=manual is impossible in invisible mode, consider using '".concat(K.Auto, "' or '").concat(K.Never, ".'")),
                                r.mode !== H.Managed && r.params["refresh-timeout"] !== oe.Auto && b("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                r.params.appearance === $.Always || r.isExecuting && r.params.appearance === $.Execute ? Lt(s, r) : Sr(s),
                                s.style.display = "";
                                var h = r.shadow.querySelector("#".concat(i));h || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                (l = h.contentWindow) === null || l === void 0 || l.postMessage({
                                    event: "init",
                                    source: U,
                                    widgetId: n.widgetId
                                }, "*");
                        ...
                        case "translationInit":
                            {
                                var x = r.shadow.getElementById(i);x || v("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074);
                                var E = new Map;r.displayLanguage = n.displayLanguage,
                                Object.keys(n.translationData).forEach(function(Y) {
                        ...
                        case "languageUnsupported":
                            {
                                b("Language ".concat(r.params.language, " is not supported, falling back to: ").concat(n.fallback, ".")),
                        ...
                        case "turnstileResults":
                            {
                                var be, q, de = (be = r.wrapper.parentNode) === null || be === void 0 ? void 0 : be.querySelector("#".concat(i, "-fr"));de || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                var re, xe = (re = r.wrapper.parentNode) === null || re === void 0 ? void 0 : re.querySelector("#".concat(i, "-fr"));xe || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                mr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var ae, we = n.token;r.isExpired = !0,
                                (ae = r.cbExpired) === null || ae === void 0 || ae.call(r, we),
                                r.params["refresh-expired"] === K.Auto && !r.isResetting && w(B.AutoExpire, i);
                                break
                            }
                        ...
                        case "interactiveBegin":
                            {
                                var Ee, ke = r.shadow.getElementById(i);ke || v("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                        ...
                        case "requestExtraParams":
                            {
                                var Re;r.widgetParamsStartTimeTsMs = j();
                                var Se = r.shadow.querySelector("#".concat(i));Se || v("Received state for an unknown widget: ".concat(n.widgetId), 3078),
                                r.isResetting = !1;
                                var ie = {},
                                    Ke = j(),
                                    Ae = {
